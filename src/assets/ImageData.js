...
export const duckGif = [
  ...
  export const angularNgForImage = [
    {
  ...
  export const angularContentProjectionChildImage = [
    {
  ...
  export const angularContentProjectionParentImage = [
    {
