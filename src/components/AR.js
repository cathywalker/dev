...
const AR = () => {
  return (
    <div>
      ...
      <div>I am currently developing two prototypes for the Vision Pro, using Xcode, Reality Composer Pro, Swift, and SwiftUI. One of which I plan to deploy to the Apple Store early next year.</div>
